...
<main>
    ...
    <section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="{{ asset('berkas/bg_top_pelatihan.png') }}">
        <div class="container">
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">Pelatihan</h3>
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4">
                    <div class="blog__sidebar pl-70">
                        ...
                        <form id="search-form" action="{{ route('pelatihan.get') }}" method="GET">
