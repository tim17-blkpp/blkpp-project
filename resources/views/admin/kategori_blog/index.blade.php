                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('kategori_blog.store') }}" method="POST">
                                        @csrf
                                ...
                                <div class="modal fade" id="editData{{ $dt->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('kategori_blog.update', $dt->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                ...
                                <div class="modal fade" id="hapusData{{ $dt->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('kategori_blog.destroy', $dt->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
