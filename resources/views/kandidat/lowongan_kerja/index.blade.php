                    ...
                    <table id="responsive-datatable" class="table table-bordered table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $dt->lowongan_kerja->judul }}
                                </td>
                                <td class="">
                                    Dipublikasikan Oleh:
                                    <u class="text-primary">
                                        <i>@if($dt->lowongan_kerja->perusahaan != null)
                                            {{ $dt->lowongan_kerja->perusahaan->name }}
                                            @else
                                            Admin Sibukin BLKPP
                                            @endif
                                        </i>
                                ...
                                <td>
                                    ...
                                    Status: <u class="text-success"><i>{{ $dt->keterangan }}</i></u>
                                    @elseif($dt->keterangan == 'Menunggu')
                                    Status: <u class="text-warning"><i>{{ $dt->keterangan }}</i></u>
                                    @else
                                    Status: <u class="text-danger"><i>{{ $dt->keterangan }}</i></u>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
