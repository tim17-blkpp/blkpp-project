...
<main>
    ...
    <section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="{{ asset('berkas/bg_top_lowongan_pekerjaan.png') }}">
        <div class="container">
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">Lowongan Pekerjaan</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Lowongan Pekerjaan</a></li>
            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-8 col-lg-8">
                    ...
                    <div class="row">
                        ...
                        @foreach($lokers as $dtb)
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div class="course__item white-bg mb-30 fix">
                                <div class="course__thumb w-img p-relative fix">
                                    <a href="{{ route('lowongan_pekerjaan.detail') . '?id=' . $dtb->id }}">
                                        <img src="{{ asset($dtb->gambar) }}" alt="">
                                    </a>
                                    <div class="course__tag">
                                        <a href="#" class="sky-blue">{{ $dtb->kategori->nama }}</a>
                                    </div>
                                </div>
                                <div class="course__content">

                                    <h3 class="course__title"><a href="{{ route('lowongan_pekerjaan.detail') . '?id=' . $dtb->id }}">{{ $dtb->judul }}</a></h3>
                                    ...
                                    <div class="course__teacher d-flex align-items-center">
                                        ...
                                        <h6>
                                            <a href="instructor-details.html">
                                                @if($dtb->perusahaan != null){{ $dtb->perusahaan->name }}@else - @endif
                                            </a>
                                        </h6>
                                    </div>
                                    <br>
                                    Gaji: {{ 'Rp ' . number_format($dtb->gaji_min, 0, ",", ".") .' - '. 'Rp ' . number_format($dtb->gaji_max, 0, ",", ".") }}
                                </div>
                                <div class="course__more d-flex justify-content-between align-items-center">
                                    <div class="course__status">
                                        <span class="sky-blue">{{ $dtb->tipe_pekerjaan }}</span>
                                    </div>
                                    <div class="course__btn">
                                        <a href="{{ route('lowongan_pekerjaan.detail') . '?id=' . $dtb->id }}" class="link-btn">
                                            Detail
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4">
                    <div class="blog__sidebar pl-70">
                        ...
                        <form id="search-form" action="{{ route('lowongan_pekerjaan.get') }}" method="GET">
                        ...
                        <div class="sidebar__widget mb-55">
                            ...
                            <div class="sidebar__widget-content">
                                <div class="rc__post-wrapper">
                                    @foreach($terbaru as $dtb)
                                    <div class="rc__post d-flex align-items-center">
                                        <div class="rc__thumb mr-20">
                                            <a href="{{ route('lowongan_pekerjaan.detail') . '?id=' . $dtb->id }}"><img src="{{ asset($dtb->gambar) }}" alt=""></a>
                                        </div>
                                        <div class="rc__content">
                                            <div class="rc__meta">
                                                <span>{{ $dtb->created_at }}</span>
                                            </div>
                                            <h6 class="rc__title"><a href="{{ route('lowongan_pekerjaan.detail') . '?id=' . $dtb->id }}">{{ $dtb->judul }}</a></h6>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
