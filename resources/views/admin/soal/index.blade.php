                        ...
                        <table id="responsive-datatable" class="table table-bordered table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small><strong class="text-primary"><u><i>Tipe: {{ $dt->tipe }}</i></u></strong><br><br></small>
                                        {!! $dt->pertanyaan !!}
                                    </td>
                                    <td>
                                        @if($dt->tipe == 'Pilihan Ganda')
                                        Kunci Jawaban: <strong>{{ $dt->kunci_jawaban }}</strong></u>
                                        <br>
                                        <a href="{{ route('soal.show', $dt->id) }}" class="text-info">
                                            <u><small>Edit Pilihan Jawaban</small></u>
                                        </a>
                                        @endif
                                    </td>
