                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="row" action="{{ route('lowongan_kerja.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            <label class="col-12 mb-2">Gaji Minimal</label>
                                            <div class="col-sm-12">
                                                <input type="number" name="gaji_min" class="form-control form-control-normal" placeholder="0" required>
                                            </div>
                                        </div>

                                        <div class="form-group col-md-6 mb-3">
                                            <label class="col-12 mb-2">Gaji Maksimal</label>
                                            <div class="col-sm-12">
                                                <input type="number" name="gaji_max" class="form-control form-control-normal" placeholder="0" required>
                                            </div>
                                        </div>

                                        <div class="form-group col-md-6 mb-3">
                                            <label class="col-12 mb-2">Tipe Pekerjaan</label>
                                            <div class="col-sm-12">
                    ...
                    <table id="responsive-datatable" class="table table-bordered table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>Kategori: </strong>{{ $dt->kategori->nama }}<br>
                                    <strong>Judul: </strong>{{ $dt->judul }}<br>
                                    <strong>Tipe: </strong>{{ $dt->tipe_pekerjaan }}
                                </td>
                                <td>
                                    <strong>Gaji Min.: </strong>{{ $dt->gaji_min }}<br>
                                    <strong>Gaji Maks.: </strong>{{ $dt->gaji_max }}
                                </td>
                                <td>
                                    <a href="{{ route('lowongan_kerja.show', $dt->id) }}" class="btn btn-sm btn-primary">Lihat Pelamar</a>
                                </td>
                                ...
                                <div class="modal fade" id="editData{{ $dt->id }}">
                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('lowongan_kerja.update', $dt->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 mb-3">
                                                            <label class="col-12 mb-2">Gaji Minimal</label>
                                                            <div class="col-sm-12">
                                                                <input type="number" name="gaji_min" value="{{ $dt->gaji_min }}" class="form-control form-control-normal" placeholder="0" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6 mb-3">
                                                            <label class="col-12 mb-2">Gaji Maksimal</label>
                                                            <div class="col-sm-12">
                                                                <input type="number" name="gaji_max" value="{{ $dt->gaji_max }}" class="form-control form-control-normal" placeholder="0" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6 mb-3">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select class="form-control" id="tipe_pekerjaan" name="tipe_pekerjaan">
                                                                    <option value="Part Time" @if($dt->tipe_pekerjaan=='Part Time') selected @endif>Part Time</option>
                                                                    <option value="Full Time" @if($dt->tipe_pekerjaan=='Full Time') selected @endif>Full Time</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                ...
                                <div class="modal fade" id="hapusData{{ $dt->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('lowongan_kerja.destroy', $dt->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
